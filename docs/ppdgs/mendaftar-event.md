...
Setelah login, Anda dapat mendaftar ke event PPDGS yang tersedia langsung dari dashboard.

```mermaid
flowchart TB
    A[Dashboard] --> B[Lihat Tabel Event]
    B --> C{Pilih Event}
    C --> D[Klik Daftar]
    D --> E[Form Biodata Muncul]
    E --> F[Isi Form & Upload Dokumen]
    F --> G[Pendaftaran Terkirim]
    G --> H[Lanjut ke Pembayaran]
```

## Melihat Daftar Event

1. Login ke akun Anda
2. Pada dashboard, Anda akan melihat tabel daftar event PPDGS yang tersedia

   | Informasi | Keterangan |
   |-----------|-----------|
   | Nama Event | PPDGS Periode 2025/2026 |
