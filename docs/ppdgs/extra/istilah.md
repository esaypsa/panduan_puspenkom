...
Memahami istilah-istilah yang digunakan dalam aplikasi PPDGS akan membantu Anda menggunakan sistem dengan lebih mudah.
...
### Aplikasi
Perangkat lunak berbasis web yang digunakan untuk mendaftar event PPDGS.

### Dashboard
Halaman utama setelah login yang menampilkan informasi penting dan menu-menu aplikasi.

### Event
Kegiatan atau program yang dapat didaftar, dalam hal ini Program Pendidikan Dokter Gigi Spesialis (PPDGS).

### Program Studi
Bidang spesialisasi dalam PPDGS, seperti:
