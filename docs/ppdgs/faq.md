...
Temukan jawaban atas pertanyaan umum seputar pendaftaran PPDGS USU.
...
<FaqAccordion :items="[
  {
    q: 'Bagaimana cara mendaftar akun di aplikasi PPDGS?',
    a: 'Buka halaman ppdgs.usu.ac.id, klik tombol Daftar, isi form dengan data diri Anda, lalu verifikasi email. Anda juga bisa mendaftar menggunakan akun Google untuk proses yang lebih cepat.'
  },
  {
  ...
  },
  {
    ...
    a: 'Ya, satu akun bisa digunakan untuk mendaftar di beberapa event PPDGS selama event tersebut masih dibuka.'
  },
  {
...
<FaqAccordion :items="[
  {
    ...
    a: 'Login ke dashboard, lalu klik menu Event atau Daftar Event untuk melihat semua event PPDGS yang sedang dibuka.'
  },
  {
...
<FaqAccordion :items="[
  ...
  },
  {
    ...
    a: 'Saat ini aplikasi dapat diakses melalui browser. Belum tersedia aplikasi mobile khusus untuk PPDGS.'
  },
  {
...
<FaqAccordion :items="[
  {
    ...
    a: 'Hubungi admin melalui WhatsApp 0811-6789-0123 atau email ppdgs@usu.ac.id pada jam kerja (Senin-Jumat, 08.00-16.00 WIB).'
  },
  {
