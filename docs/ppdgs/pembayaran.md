...
![Screenshot Menu Pembayaran](/images/ppdgs/pembayaran.png)
...
![Screenshot Form Upload Bukti](/images/ppdgs/pembayaran-upload-modal.png)
...
Setelah pembayaran diverifikasi, Anda bisa memantau [Status Pendaftaran](/ppdgs/status-pendaftaran).
