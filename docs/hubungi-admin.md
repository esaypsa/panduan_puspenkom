...
sequenceDiagram
    ...
    P->>A: Mengirim Pertanyaan
    Note over P,A: Via WhatsApp / Email
    A->>A: Memeriksa Pertanyaan
    A->>P: Memberikan Jawaban
    Note over P,A: 1x24 Jam (Hari Kerja)
    P->>A: Konfirmasi Penerimaan
```
...
<div class="info-card-title"><img src="/images/icons/whatsapp.svg" alt="WhatsApp" style="vertical-align:middle;margin-right:4px"> WhatsApp</div>
