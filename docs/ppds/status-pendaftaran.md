...
![Screenshot Status Pendaftaran](/images/ppds/placeholder-status.svg)
...
Jika ada pertanyaan tentang status pendaftaran, cek [FAQ](/ppds/faq) atau [Hubungi Kami](/hubungi-admin).
