...
Setelah login, Anda akan langsung melihat halaman dashboard yang menampilkan tabel daftar event PPDS yang sedang berlangsung. Setiap baris event dilengkapi dengan tombol **"Daftar"** untuk memulai pendaftaran.

![Screenshot Dashboard](/images/ppds/dashboard-peserta.png)
...
- [Mendaftar event](/ppds/mendaftar-event) dengan mengklik tombol **"Daftar"** pada event yang tersedia
- [Melengkapi biodata](/ppds/form-biodata) (termasuk unggah Bukti Bayar di Tab Data Diri)
